...
## 1. Goal
Bring the object-oriented, deterministic `BaseRuleEngine` from python (`grelin-ai/apps/wound-ai/validation/engines/base.py`) into the Bree-AI Monorepo as a Bun/TypeScript abstract class package in `apps/ai-playbooks/rules-engine/core/base.ts`. 
