...
export const assessmentDb = {
  create: (data: any): any => {
    ...
    `).run({
      ...
      $conversation_data: data.conversation_data ? JSON.stringify(data.conversation_data) : null,
      $feedback_data: data.feedback_data ? JSON.stringify(data.feedback_data) : null,
      $resume_file_path: data.resume_file_path || null,
      $resume_parsed_data: data.resume_parsed_data ? JSON.stringify(data.resume_parsed_data) : null,
