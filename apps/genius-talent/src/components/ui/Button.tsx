...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-brand-orange text-white hover:bg-brand-orange-dark active:bg-brand-orange-dark shadow-lg hover:shadow-brand-orange/25',
      secondary:
        'bg-dark-700 text-dark-100 hover:bg-dark-600 active:bg-dark-500 border border-dark-600',
      outline:
        'bg-transparent text-brand-orange border-2 border-brand-orange hover:bg-brand-orange hover:text-white',
      ghost:
