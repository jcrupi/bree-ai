...
import { Task, Agent, Area, Project, TaskStatus, TaskPriority, AgentType, AILens, AILensAnalysis, AgentXRequest, AgentXResponse, LensCategory, AgentXNote } from '../types';
...
export interface ApiRoutes {
  tasks: {
    ...
    ':id': {
      ...
      delete: (id: string) => Promise<EdenResponse<{
        success: boolean;
      }>>;
    };
  };
