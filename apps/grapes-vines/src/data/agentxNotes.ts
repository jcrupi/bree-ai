...

{
  ...
  title: 'Urgent Lens',
  description: 'Scans all Vines, tasks, and grapes for anything urgent that needs immediate attention. Detects blockers, escalations, missed deadlines, and time-sensitive requests. Prioritizes by severity.',
  type: 'lens',
  version: '1.2.0',
  ...
  bindings: [{
    ...
    verb: 'request',
    description: 'Routes through AgentX Collective for orchestrated analysis'
  }],
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.dashboard', 'bree.pages.team', 'bree.pages.vines', 'bree.pages.task-board', 'bree.components.task-list', 'bree.components.vines-panel', 'bree.components.vines-sidebar-section'],
  agents: [{
    id: 'ai2',
  ...
  dataProvides: ['urgencyReport', 'severityRanking', 'actionItems', 'blockerList'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'Grape[]', 'Project'],
  stateKeys: [],
  capabilities: ['blocker-detection', 'deadline-scanning', 'escalation-flagging', 'severity-ranking', 'action-item-generation'],
  ...
  title: 'Risk Scanner',
  description: 'Identifies potential bottlenecks, delays, stale branches, and high-risk items across tasks, conversations, and code. Generates risk heatmaps and mitigation recommendations.',
  type: 'lens',
  version: '1.3.0',
  ...
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.dashboard', 'bree.pages.team', 'bree.pages.vines', 'bree.pages.task-board', 'bree.pages.architecture', 'bree.components.task-list', 'bree.components.projects-view', 'bree.components.vines-visual'],
  agents: [{
    id: 'ai2',
  ...
  dataProvides: ['riskHeatmap', 'bottleneckList', 'mitigationPlan', 'riskScore'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'Grape[]', 'Project', 'GitBranch[]'],
  stateKeys: [],
  capabilities: ['risk-heatmap', 'bottleneck-detection', 'stale-detection', 'dependency-analysis', 'mitigation-recommendations'],
  ...
  description: 'Summarizes completion rates, velocity trends, and forecasts delivery timelines. Generates progress charts with area-by-area breakdowns and AI-powered insights.',
  type: 'lens',
  version: '1.4.0',
  ...
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.dashboard', 'bree.pages.team', 'bree.pages.task-board', 'bree.components.task-list', 'bree.components.projects-view', 'bree.components.sidebar', 'bree.components.tasks-sidebar-section', 'bree.components.team-member-card', 'bree.hooks.use-agent-tasks'],
  agents: [{
    id: 'ai2',
    role: 'Velocity calculation and trend analysis',
    permissions: ['read', 'analyze']
  }],
  dataProvides: ['velocityReport', 'completionForecast', 'areaBreakdown', 'trendCharts'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'Project'],
  stateKeys: [],
  capabilities: ['velocity-tracking', 'completion-forecasting', 'area-breakdown', 'trend-visualization', 'ai-insights'],
  ...
  description: 'Synthesizes context from tasks, conversations, and grapes to suggest new features, improvements, and creative directions. Generates idea cards with related task/vine links.',
  type: 'lens',
  version: '1.1.0',
  ...
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.dashboard', 'bree.pages.team', 'bree.pages.vines', 'bree.pages.architecture', 'bree.components.vines-panel'],
  agents: [{
    id: 'ai1',
  ...
  dataProvides: ['ideaCards', 'featureSuggestions', 'improvementPlan', 'relatedContext'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'Grape[]', 'Project'],
  stateKeys: [],
  capabilities: ['creative-synthesis', 'feature-suggestion', 'pattern-recognition', 'idea-cards', 'context-linking'],
  specialties: ['ux', 'ui'],
  author: 'bree-core',
  createdAt: '2024-01-15',
  updatedAt: '2024-02-06',
  ...
  description: 'Reviews tasks, code activity, and conversations for security implications. Generates security scores, flags vulnerabilities, and recommends governance practices.',
  type: 'lens',
  version: '1.2.0',
  ...
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.vines', 'bree.pages.architecture', 'bree.components.architecture-node'],
  agents: [{
    id: 'ai3',
    role: 'Vulnerability scanning and security posture assessment',
    permissions: ['read', 'analyze', 'execute']
  }],
  dataProvides: ['securityScore', 'vulnerabilityReport', 'complianceChecklist', 'remediationPlan'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'GitBranch[]', 'Project'],
  stateKeys: [],
  capabilities: ['vulnerability-scanning', 'security-scoring', 'compliance-checking', 'secret-detection', 'remediation-planning'],
  ...
  description: 'Analyzes task dependencies, effort estimates, and impact scores to recommend optimal execution order. Generates priority timelines with unblock chains.',
  type: 'lens',
  version: '1.3.0',
  ...
  lensAccepts: [],
  lensIncludes: [],
  targetComponents: ['bree.pages.project-board', 'bree.pages.dashboard', 'bree.pages.task-board', 'bree.components.task-list', 'bree.components.sidebar', 'bree.hooks.use-agent-tasks'],
  agents: [{
    id: 'ai2',
    role: 'Dependency graph analysis and impact scoring',
    permissions: ['read', 'analyze', 'write']
  }],
  dataProvides: ['optimizedOrder', 'impactScores', 'unblockChains', 'effortEstimates'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'Project'],
  stateKeys: [],
  capabilities: ['dependency-analysis', 'impact-scoring', 'effort-estimation', 'priority-timeline', 'unblock-chain-mapping'],
...

{
  ...
  title: 'Project Board',
  description: 'Primary project workspace showing tasks, vines, grapes, and git in a bento grid. Supports expanded card views and is the main AI lens drop target surface.',
  type: 'page',
  version: '2.1.0',
  ...
  lensAccepts: ['urgent-lens', 'risk-scanner', 'progress-analyst', 'idea-generator', 'security-auditor', 'priority-optimizer'],
  lensIncludes: [],
  ...
  dataProvides: ['projectTasks', 'projectVines', 'projectGrapes', 'gitBranches', 'taskStats', 'progress'],
  dataConsumes: ['Project', 'Task[]', 'VineConversation[]', 'Grape[]', 'TeamMember[]'],
  stateKeys: ['expandedCard', 'expandedTaskId'],
  capabilities: ['lens-drop-target', 'card-expansion', 'task-status-display', 'vine-preview', 'grape-tracking', 'git-branch-view'],
  ...
  title: 'Dashboard',
  description: 'Overview dashboard with sidebar navigation, task lists, project views, and vine panels. Supports specialty filtering and agent/area/project selection.',
  type: 'page',
  version: '1.5.0',
  ...
  lensAccepts: ['urgent-lens', 'risk-scanner', 'progress-analyst', 'priority-optimizer'],
  lensIncludes: [],
  ...
  dataProvides: ['allTasks', 'filteredTasks', 'tasksByStatus', 'vineConversations', 'stats'],
  dataConsumes: ['Task[]', 'Agent[]', 'Area[]', 'Project[]', 'VineConversation[]', 'SpecialtyType[]'],
  stateKeys: ['selectedAgentId', 'selectedAreaId', 'selectedProjectId', 'selectedVineId', 'vineConversations'],
  capabilities: ['lens-drop-target', 'specialty-filtering', 'agent-selection', 'project-navigation', 'vine-management'],
  specialties: ['ui', 'ux'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  ...
  title: 'Team Board',
  description: 'Displays all team members organized by category (Design, Human Agents, AI Agents) with stats, skills, and recent activity feed.',
  type: 'page',
  version: '1.2.0',
  ...
  lensAccepts: ['urgent-lens', 'risk-scanner', 'progress-analyst', 'idea-generator'],
  lensIncludes: [],
  ...
  dataProvides: ['teamMembers', 'memberStats', 'recentActivity', 'categoryBreakdown'],
  dataConsumes: ['TeamMember[]', 'Task[]', 'VineConversation[]', 'Agent[]'],
  stateKeys: [],
  capabilities: ['lens-drop-target', 'member-categorization', 'activity-feed', 'stat-cards'],
  ...
  description: 'Immersive vine visualization with node-based team member selection, conversation threading, and floating message overlays. Dark theme with organic visual language.',
  type: 'page',
  version: '1.8.0',
  ...
  lensAccepts: ['urgent-lens', 'risk-scanner', 'idea-generator', 'security-auditor'],
  lensIncludes: [],
  ...
  dataProvides: ['vineConversations', 'selectedMember', 'selectedConversation', 'messageStream'],
  dataConsumes: ['TeamMember[]', 'VineConversation[]'],
  stateKeys: ['selectedMemberId', 'selectedConversationId'],
  capabilities: ['lens-drop-target', 'node-visualization', 'conversation-threading', 'message-overlay', 'member-inspection'],
  specialties: ['messaging', 'ui', 'ux'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  tags: ['page', 'vines', 'lens-aware', 'immersive', 'dark-theme', 'real-time']
}, {
  id: 'bree.pages.task-board',
  component: 'pages/TaskBoardPage.tsx',
  title: 'Task Board',
  description: 'Single-task focused workspace with tabbed views for task overview, vine chat, and CLI terminal. Includes acceptance criteria checklist and task switching.',
  type: 'page',
  version: '1.4.0',
  ...
  dataProvides: ['activeTask', 'todos', 'cliHistory', 'vineChat', 'taskProgress'],
  dataConsumes: ['Task[]', 'VineConversation[]', 'TeamMember[]'],
  stateKeys: ['activeTaskIndex', 'activeTab', 'todos', 'cliInput', 'cliHistory', 'vineInput'],
  capabilities: ['lens-drop-target', 'task-switching', 'checklist-management', 'vine-chat', 'cli-terminal'],
  specialties: ['ui', 'backend', 'devops'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  tags: ['page', 'task', 'lens-aware', 'tabbed', 'terminal', 'focused-workspace']
}, {
  id: 'bree.pages.architecture',
  component: 'pages/ArchitecturePage.tsx',
  title: 'Architecture View',
  description: 'System architecture visualization showing frontend apps, backend services, shared core, and external services in a layered diagram with connecting lines.',
  type: 'page',
  version: '1.1.0',
  ...
  stateKeys: [],
  capabilities: ['lens-drop-target', 'layered-diagram', 'service-nodes', 'tech-stack-display'],
...

{
  ...
  title: 'AI Lens Menu',
  description: 'Fixed sidebar menu displaying all available AI lenses with custom geometric SVG icons. Supports drag-to-analyze interaction pattern. Dark glass panel aesthetic.',
  type: 'component',
  version: '2.0.0',
  ...
  lensAccepts: [],
  lensIncludes: ['urgent-lens', 'risk-scanner', 'progress-analyst', 'idea-generator', 'security-auditor', 'priority-optimizer'],
  agents: [{
    id: 'ai1',
  ...
  dataConsumes: ['AILens[]'],
  stateKeys: [],
  capabilities: ['lens-drag-source', 'custom-svg-icons', 'tooltip-descriptions', 'staggered-animation'],
  specialties: ['ui'],
  author: 'bree-core',
  createdAt: '2024-01-15',
  updatedAt: '2024-02-06',
  ...
  description: 'Full-screen modal overlay that displays AI analysis results with lens-specific visualizations (risk heatmap, progress charts, idea cards, security scores, priority optimizer). Includes follow-up chat interface.',
  type: 'component',
  version: '1.6.0',
  ...
  dataConsumes: ['AILens', 'Task[]', 'VineConversation[]', 'Grape[]', 'Project'],
  stateKeys: ['messages', 'inputValue', 'isTyping'],
  capabilities: ['risk-heatmap', 'progress-charts', 'idea-cards', 'security-score', 'priority-timeline', 'follow-up-chat'],
  specialties: ['ui', 'ux'],
  author: 'bree-core',
  createdAt: '2024-01-15',
  updatedAt: '2024-02-06',
  ...
  description: 'Main navigation sidebar with agent list, area filters, project tree, vine conversations, and drag-to-project task management.',
  type: 'component',
  version: '1.3.0',
  ...
  dataConsumes: ['Agent[]', 'Area[]', 'Project[]', 'Task[]', 'VineConversation[]', 'SpecialtyType[]'],
  stateKeys: [],
  capabilities: ['agent-selection', 'area-filtering', 'project-tree', 'vine-sidebar', 'task-drag-to-project'],
  specialties: ['ui', 'ux'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  ...
  title: 'Specialty Bar',
  description: 'Horizontal filter bar for toggling domain specialties. Filters propagate to all child views.',
  type: 'component',
  version: '1.0.0',
  ...
  title: 'Task List',
  description: 'Displays tasks grouped by status with inline editing, priority badges, agent avatars, and vine/grape link indicators.',
  type: 'component',
  version: '1.4.0',
  ...
  dataConsumes: ['Task[]', 'Agent[]', 'Area[]', 'Project[]', 'VineConversation[]'],
  stateKeys: [],
  capabilities: ['status-grouping', 'inline-editing', 'task-creation', 'priority-display', 'vine-linking'],
  specialties: ['ui', 'ux'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  ...
  title: 'Projects View',
  description: 'Grid view of all projects with task counts, progress indicators, and vine activity summaries.',
  type: 'component',
  version: '1.1.0',
  ...
  stateKeys: [],
  capabilities: ['project-grid', 'progress-indicators', 'vine-activity', 'navigation'],
  specialties: ['ui'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  ...
  title: 'Vines Panel',
  description: 'Inline conversation panel for viewing and participating in vine chats within the dashboard context.',
  type: 'component',
  version: '1.2.0',
  ...
  agents: [{
    ...
    id: 'ai2',
    role: 'Urgency flagging',
    permissions: ['read', 'analyze']
  }],
  dataProvides: ['conversationView', 'messageStream'],
  dataConsumes: ['VineConversation', 'TeamMember[]'],
  stateKeys: [],
  capabilities: ['message-display', 'message-sending', 'participant-avatars', 'real-time-updates'],
  ...
  title: 'Vines Visual',
  description: 'Organic node-based visualization of team members and their vine connections.',
  type: 'component',
  version: '1.5.0',
  ...
  dataConsumes: ['TeamMember[]', 'VineConversation[]'],
  stateKeys: [],
  capabilities: ['node-graph', 'edge-connections', 'animated-svg', 'interactive-selection'],
  ...
  dataConsumes: [],
  stateKeys: [],
  capabilities: ['service-display', 'tech-badges', 'port-indicator', 'layer-coloring'],
  ...
  description: 'Individual team member display with avatar, role, status indicator, skills, and task/vine counts.',
  type: 'component',
  version: '1.0.0',
  ...
  stateKeys: [],
  capabilities: ['avatar-display', 'status-indicator', 'skill-badges', 'stat-counts'],
  specialties: ['ui'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
  ...
  title: 'Badge',
  description: 'Reusable badge/chip component for status labels, priority indicators, and category tags.',
  type: 'component',
  version: '1.0.0',
  ...
  description: 'Compact vine conversation list in the sidebar with unread indicators.',
  type: 'component',
  version: '1.0.0',
  ...
  agents: [{
    id: 'ai2',
    role: 'Unread prioritization',
    permissions: ['read']
  }],
  dataProvides: ['sidebarVineSummary', 'unreadCounts'],
  dataConsumes: ['VineConversation[]'],
  stateKeys: [],
  capabilities: ['vine-list', 'unread-indicators', 'message-preview', 'vine-selection'],
  specialties: ['messaging', 'ui'],
  author: 'bree-core',
  createdAt: '2024-01-01',
  updatedAt: '2024-02-06',
...

{
  ...
  description: 'Primary data hook that fetches and manages tasks, agents, areas, and projects via the Bree Eden API client.',
  type: 'hook',
  version: '1.5.0',
  ...
  dataProvides: ['tasks', 'agents', 'areas', 'projects', 'tasksByStatus', 'stats', 'selectedSpecialties'],
  dataConsumes: [],
  stateKeys: ['tasks', 'agents', 'areas', 'projects', 'selectedAgentId', 'selectedAreaId', 'selectedProjectId', 'selectedSpecialties'],
  capabilities: ['api-fetching', 'task-crud', 'project-crud', 'specialty-filtering', 'computed-stats'],
  ...
  description: 'Global AI Lens context provider and hooks. Manages lens drag state, drop zone registration, AgentX communication, analysis history, and overlay state.',
  type: 'provider',
  version: '2.0.0',
  ...
  agents: [{
    ...
    id: 'ai3',
    role: 'Security context injection',
    permissions: ['read']
  }],
  dataProvides: ['isDragging', 'activeLens', 'analysisResult', 'agentXStatus', 'analysisHistory', 'dropZones'],
  dataConsumes: ['AILens[]', 'AgentXResponse'],
  stateKeys: ['isDragging', 'draggingLensId', 'dragOverZoneId', 'isOverlayOpen', 'activeLens', 'activeZone', 'analysisResult', 'lastAgentXResponse', 'analysisHistory', 'agentXStatus'],
  capabilities: ['lens-drag-management', 'drop-zone-registry', 'agentx-communication', 'analysis-history', 'overlay-control'],
...

{
  ...
  description: 'Eden Treaty-style API client for all Bree services. Provides typed endpoints for tasks, agents, areas, projects, AI lenses, and AgentX communication.',
  type: 'api',
  version: '2.0.0',
  ...
  dataProvides: ['tasks', 'agents', 'areas', 'projects', 'lenses', 'analyses', 'agentxResponses'],
  dataConsumes: [],
  stateKeys: [],
  capabilities: ['eden-treaty-pattern', 'mock-mode', 'real-api-mode', 'typed-endpoints', 'lens-crud', 'agentx-communication'],
  ...
  component: 'App.tsx',
  title: 'App Root',
  description: 'Root application component. Wraps all routes in AILensProvider and renders global AI Lens UI (menu + overlay).',
  type: 'provider',
  version: '2.0.0',
...
export function getNoteByComponent(componentPath: string): AgentXNote | undefined {
...
export function getLensTargetComponents(lensNoteId: string): AgentXNote[] {
  ...
  return lensNote.targetComponents.map((id) => getNoteById(id)).filter((n): n is AgentXNote => n !== undefined);
}
...
export function getNotesByNatsSubject(subject: string): AgentXNote[] {
  return AGENTX_NOTES.filter((n) => n.natsSubject === subject || n.bindings.some((b) => b.subject === subject));
}
