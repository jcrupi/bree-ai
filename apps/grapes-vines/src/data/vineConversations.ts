...
export const VINE_CONVERSATIONS: VineConversation[] = [{
  ...
  messages: [{
    ...
    content: 'Hey Marcus, I was thinking about the hero section animation. Can we make it more subtle?',
    ...
    content: 'Sure Mary! I can adjust the easing curve. Did you have a specific reference in mind?',
    ...
    senderName: 'Marcus',
    senderCategory: 'human-ai',
    content: 'Got it. I will switch to a spring physics model with high damping. Give me 10 mins.',
  ...
  messages: [{
    ...
    senderName: 'John',
    senderCategory: 'human-design',
    content: 'Alex, are we using a relational model for the user preferences?',
    ...
    senderName: 'Alex',
    senderCategory: 'human-ai',
    content: 'I was planning on JSONB for flexibility, since the preferences schema changes often.',
  ...
  messages: [{
    ...
    senderName: 'Mary',
    senderCategory: 'human-design',
    content: 'Oh? They should be 44px minimum. Let me check the Figma file.',
    ...
    senderName: 'Sara',
    senderCategory: 'human-ai',
    content: 'The implementation rendered at 38px due to padding. I will bump the padding.',
