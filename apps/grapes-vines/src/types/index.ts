...
export type SpecialtyType = 'ui' | 'ux' | 'backend' | 'messaging' | 'database' | 'security' | 'governance' | 'devops';
...
export type ComponentType = 'page' | 'component' | 'hook' | 'data' | 'api' | 'provider' | 'lens';
