  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="mt-12 p-6 bg-[#0f0f0f] border border-[#333] rounded-lg">
        <div className="text-sm text-gray-400 mb-4">Comparison</div>
        <div className="grid grid-cols-3 gap-8">
          <div>
            <div className="text-gray-500 text-sm mb-1">Jira</div>
            <div className="text-2xl font-bold text-red-400 mb-2">8.2MB</div>
            <div className="text-xs text-gray-500">6.3s load · 1000+ features</div>
          </div>

          <div>
            <div className="text-gray-500 text-sm mb-1">LeanBoard</div>
            <div className="text-2xl font-bold text-[#00d9ff] mb-2">385KB</div>
            <div className="text-xs text-gray-500">0.3s load · 8 features</div>
          </div>
