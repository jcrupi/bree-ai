...
agentx:
  ...
  type: algo
  filename: enm-ai.algos.agentx-v2.md
---
...
|-----|---------------------|
| 02, 10 | 99202–99215 (with modifier 95/93; verify payer policy) |
| 11 | 99202–99215, 99242–99245 |
| 12, 13 | 99341–99350 |
| 21 (Inpatient) | 99221–99239, 99252–99255 |
| 22 (Outpatient hospital) | 99202–99215 |
| 23 (ED) | 99281–99285 |
| 31, 32 (SNF/NF) | 99304–99318 |
| — | 99381–99397 (Preventive; setting independent) |
...
| condition | `place_of_service not in {02, 10, 11, 12, 13, 21, 22, 23, 31, 32}` |
| action | FAIL, remediation: "Invalid place of service. Use CMS POS codes (02, 10, 11, 12, 13, 21, 22, 23, 31, 32)." |
...
### EM.PRV.100 — Preventive Age Logic (Real)

| Field | Value |
|-------|-------|
| rule_id | EM.PRV.100 |
| severity | CLAIM_BLOCK |
| condition | `chosen_code in {99381, 99391} and patient_age_years >= 1` |
| action | FAIL, remediation: "Code 99381/99391 is for patients < 1 year old." |
| condition | `chosen_code in {99382, 99392} and (patient_age_years < 1 or patient_age_years > 4)` |
| action | FAIL, remediation: "Code 99382/99392 is for patients age 1–4 years." |
| condition | `chosen_code in {99383, 99393} and (patient_age_years < 5 or patient_age_years > 11)` |
| action | FAIL, remediation: "Code 99383/99393 is for patients age 5–11 years." |
| condition | `chosen_code in {99384, 99394} and (patient_age_years < 12 or patient_age_years > 17)` |
| action | FAIL, remediation: "Code 99384/99394 is for patients age 12–17 years." |
| condition | `chosen_code in {99385, 99395} and (patient_age_years < 18 or patient_age_years > 39)` |
| action | FAIL, remediation: "Code 99385/99395 is for patients age 18–39 years." |
| condition | `chosen_code in {99386, 99396} and (patient_age_years < 40 or patient_age_years > 64)` |
| action | FAIL, remediation: "Code 99386/99396 is for patients age 40–64 years." |
| condition | `chosen_code in {99387, 99397} and patient_age_years < 65` |
| action | FAIL, remediation: "Code 99387/99397 is for patients age 65+ years." |

### EM.CCM.110 — Care Management Time Logic (Real)

| Field | Value |
|-------|-------|
| rule_id | EM.CCM.110 |
| severity | CLAIM_BLOCK |
| condition | `chosen_code == "99490" and clinical_staff_time_minutes < 20` |
| action | FAIL, remediation: "CCM 99490 requires at least 20 minutes of clinical staff time." |
| condition | `chosen_code == "99491" and physician_time_minutes < 30` |
| action | FAIL, remediation: "CCM 99491 requires at least 30 minutes of physician/QHP time." |

### EM.MOD.120 — Modifier 25 Consistency (Real)

| Field | Value |
|-------|-------|
| rule_id | EM.MOD.120 |
| severity | CLAIM_BLOCK |
| condition | `has_procedure_code(claims) and is_em_code(chosen_code) and "25" not in modifiers` |
| action | FAIL, remediation: "Significant separately identifiable E/M service on the same day as a procedure requires Modifier 25." |
