...
export function TalentVillageBoard() {
  ...
  const handleCreateTalentVine = () => {
    ...
    const link = `${window.location.origin}/talent-village?role=expert&name=${encodeURIComponent(newExpertName.trim())}&vineId=${vineId}`;
             ...
             <div className="flex items-center gap-2">
               <div className="flex p-1 bg-slate-100 rounded-full gap-1">
                 {([
                   ...
                   { id: 'self', label: '👑 Lead', title: 'Your lead expert dashboard' },
               ...
               {isLead && (
                 <button
                   onClick={() => { setShowCreateVine(true); setCreatedVineLink(''); setNewExpertName(''); }}
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-indigo-50/10">
                      ...
                      {privateExpertMessages.map((msg) => (
                        <div key={msg.id} className="flex flex-col gap-1">
                          ...
                          <div className="bg-white border border-indigo-100 p-4 rounded-2xl rounded-tl-none shadow-sm text-[13px] text-slate-600 leading-relaxed">{msg.content}</div>
                        </div>
                      ))}
              ...
              <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-1 custom-scrollbar">
                ...
                <div className="flex flex-col md:flex-row gap-6" style={{ minHeight: '420px' }}>
                  ...
                  <div className="flex-1 bg-[#D3CFEF]/30 rounded-[32px] border-2 border-[#D3CFEF] flex flex-col overflow-hidden relative">
                    ...
                    {/* Lead Expert Direct Intervention Chat */}
                    {isLead && (
                      <div className="p-4 bg-white border-t border-indigo-200/50 flex-shrink-0">
                        <form onSubmit={handleInjectQuestion} className="flex gap-2">
                          <input
                            type="text"
                          ...
                          <button 
                            type="submit" 
                            className="px-4 py-3 bg-rose-500 text-white font-bold rounded-xl hover:bg-rose-600 transition-all flex items-center gap-2 shadow-sm shadow-rose-500/20"
                          >
                            <Send size={16} />
                            <span>Send</span>
                          </button>
                    ...
                    {/* AI Lenses badge */}
                    <div className="absolute bottom-4 left-4 bg-slate-900 rounded-full px-4 py-2 flex items-center gap-2 shadow-xl border border-white/5 z-10 cursor-pointer hover:scale-105 transition-transform">
                  ...
                  >
                    ...
                    {!isExpertChatCollapsed && (
                      ...
                      {privateExpertMessages.map((msg) => (
                        <div key={msg.id} className="flex flex-col gap-1">
                          <span className="text-[9px] font-bold text-indigo-500 uppercase tracking-wider">{msg.sender}</span>
                          <div className="bg-white border border-indigo-100 p-3 rounded-2xl rounded-tl-none shadow-sm text-[13px] text-slate-600 leading-relaxed">{msg.content}</div>
                        </div>
                      ))}
                      <div ref={expertEndRef} />
                    </div>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-slate-800">Create Talent Vine</h2>
                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Lead Expert · Invite Link</p>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                <div>
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-2 pl-1">Expert Name</label>
                  <input
                    type="text"
                    value={newExpertName}
                ...
                <button
                  ...
                  className="w-full py-4 bg-[#3876F2] text-white font-bold rounded-2xl shadow-lg shadow-blue-500/20 hover:bg-blue-600 disabled:opacity-30 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
                  <Sparkles size={16} />
                  Generate Vine Link
                </button>
                  ...
                  >
                    <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl">
                      ...
                      <p className="text-[10px] text-emerald-600 mt-2 text-center">
                        Share this link with <strong>{newExpertName}</strong> to join the vine
                      </p>
                    </div>
                    <button
