                    ...
                    <div className="space-y-3">
                      {expertRoster.length === 0 ? (
                        <div className="py-6 text-center border-2 border-dashed border-slate-100 rounded-2xl">
                          ...
                          <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">No experts connected yet</p>
                          <p className="text-[9px] text-slate-300 mt-1">Experts will appear here after they send a message in the Expert Vine Chat</p>
                        </div>
                      ) : (
